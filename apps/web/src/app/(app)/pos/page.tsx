...
import { formatIDR, filterProducts, getProductCategories } from '@/lib/utils'
import { Product, CartItem, Member } from '@/lib/types'
import MemberSearch from '@/components/MemberSearch'
import { MemberCombobox } from '@/components/MemberCombobox'
import ProductCard from '@/components/ProductCard'
import { ShoppingCart, Plus, Minus, Search, User, CreditCard, Package, Loader2, Camera, Trash2, Gift } from 'lucide-react'
import {
  Dialog,
  DialogContent,
  DialogHeader,
