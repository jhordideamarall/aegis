...
export default function POSPage() {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      {/* Mobile Floating Checkout Bar (Liquid Glass) - STICKY AT BOTTOM */}
      <div className="md:hidden fixed bottom-12 left-0 right-0 z-40 px-4 pb-4 pt-2 bg-gradient-to-t from-gray-50 to-transparent">
      ...
      {showCartSheet && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          />
          <div className="absolute left-0 right-0 bottom-13 bg-white rounded-t-2xl max-h-[85vh] flex flex-col">
